...
| **Day 14** | **Git Flow & Xử lý xung đột**:<br>- Quản lý nhánh (`feature/...`)<br>- Pull Request (PR) & Code Review | Giả lập phối hợp chỉnh sửa file trên 2 nhánh khác nhau để tạo xung đột (Merge Conflict). Hướng dẫn sinh viên cách dùng IDE đọc thẻ conflict và xử lý. | ✅ `Done` | [Link]() |
...
| :---: | :--- | :---: | :--- |
| **Day 15** | Cài đặt Arduino IDE. Lập trình đọc dữ liệu từ Cảm biến nhiệt độ phòng. Định dạng chuỗi truyền thông chuẩn gửi qua cổng Serial (USB). | 🔄 `In Progress` | [Link]() |
